...
<!--  Includes mode "metadata" for front matter, along with 
  ...
  <xsl:template match="title-group" mode="metadata">
    <!-- content model:
    fe, subtitle*, trans-title-group*, alt-title*, fn-group? -->
...
<!-- ============================================================= -->
  ...
  <!--													-->
  <!--				Annotaria Customization				-->
  <!--													-->
  <xsl:template match="name[ancestor::citation or ancestor::mixed-citation or ancestor::element-citation]">
  	<span class="ref-citation-name">
       <xsl:apply-templates/>  
    </span>
  ...
  <xsl:template match="surname[ancestor::citation or ancestor::mixed-citation or ancestor::element-citation]">
  	<span class="ref-citation-surname">
      <xsl:apply-templates/>  
  	</span>
  </xsl:template>  	
  
  <xsl:template match="given-names[ancestor::citation or ancestor::mixed-citation or ancestor::element-citation]">
  	<xsl:text> </xsl:text>
  	<span  class="ref-citation-given-name">
      <xsl:apply-templates/>.  
  	</span>
  </xsl:template>  	  
  
  
  <xsl:template match="source[ancestor::citation or ancestor::mixed-citation or ancestor::element-citation]">
  	<xsl:text> </xsl:text>
  	<span  class="ref-citation-source">
      <xsl:apply-templates/>  
  	</span>.
  	<xsl:text> </xsl:text>
  </xsl:template>  	  
  
  <xsl:template match="volume[ancestor::citation or ancestor::mixed-citation or ancestor::element-citation]"/>
  <xsl:template match="issue[ancestor::citation or ancestor::mixed-citation or ancestor::element-citation]"/>  
  <xsl:template match="fpage[ancestor::citation or ancestor::mixed-citation or ancestor::element-citation]"/>
  <xsl:template match="lpage[ancestor::citation or ancestor::mixed-citation or ancestor::element-citation]"/>
  
  <xsl:template match="pub-id[ancestor::citation or ancestor::mixed-citation or ancestor::element-citation]">
  	<xsl:text> </xsl:text>
  	<xsl:value-of select="upper-case(@pub-id-type)"/>:
  	<xsl:text> </xsl:text>
  	
  	<span  class="{concat('ref-citation-',@pub-id-type)}">
      <xsl:apply-templates/>  
  	</span>.
  </xsl:template>
  
    
  <xsl:template match="year[ancestor::citation or ancestor::mixed-citation or ancestor::element-citation]">
  	<xsl:text> </xsl:text>
  	<span  class="ref-citation-year">
      <xsl:apply-templates/>  
  	</span>.
  </xsl:template>
  
  <xsl:template match="article-title[ancestor::citation or ancestor::mixed-citation or ancestor::element-citation]"> 	
  	<span  class="ref-citation-article-title">
      <xsl:apply-templates/>  
  	</span>
  	<xsl:text> </xsl:text>
  </xsl:template>
  <!--													-->
  <!--			/END	Annotaria Customization			-->
  <!--													-->
